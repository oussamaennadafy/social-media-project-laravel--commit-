...
@section('content')
    <div class="flex justify-center mb-20">
     <div class="w-8/12 bg-white p-6 rounded-lg">
       <h1 class="text-xl text-center font-semibold my-3">Edit Profile</h1>
       <form action="{{ route('Profile.edit', $users->id) }}" method="POST" class=" bg-white flex flex-col gap-2 py-2 rounded-lg">
        @csrf
        ...
        <div class="w-96 flex items-center justify-between mx-auto">
         ...
         <input placeholder="New password"  class="bg-gray-200 border border-gray-300 focus:outline-none rounded px-3 w-64 py-2" type="password" name="password" id="password">
        </div>
       ...
       <input class="bg-red-700 cursor-pointer w-1/4 mx-auto text-white mt-2 border border-gray-300 rounded px-4 py-2" value='Delete Account' type="submit" name="submit-profile">
